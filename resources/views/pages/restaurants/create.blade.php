                        ...
                        <div class="card-body">
                            ...
                            <div class="row row-cols-1  ">
                                ...
                                <x-form.input name="address[address_ae]" wire:model="address_ae"
                                    label="{{ __('sentence.restaurant_address_arabic ') }} *" autofocus required />
                            </div>
                            <div class="row row-cols-2  ">
                                <x-form.input name="address[city]" wire:model="city"
                                    label="{{ __('sentence.restaurant_city') }}" autofocus />
                                <x-form.input name="address[post_code]" wire:model="post_code"
                                    label="{{ __('sentence.restaurant_post_code') }}" autofocus />
