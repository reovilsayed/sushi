        ...
        <div class="container position-relative d-flex align-items-center justify-content-between">
            ...
            <div class="d-xl-flex d-none">
                ...
                <a class="fs-4 " href="{{ route('restaurant.cart') }}"><svg version="1.0"
                        ...
                        <g transform="translate(0.000000,50.000000) scale(0.100000,-0.100000)" fill="#ff883e"
                            stroke="none">
                            <path
                ...
                @auth
                    <a class="d-xl-block" style="margin: 0 20px;" 
                        href="{{ route('user.dashboard') }}">
                        <svg version="1.0" xmlns="http://www.w3.org/2000/svg" height="2.5em" viewBox="0 0 100 100" preserveAspectRatio="xMidYMid meet">
