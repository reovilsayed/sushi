...
<div class="nav_inner">
    <ul class="nav_list">
        ...
        <x-sidenav.nav name="{{ __('sentence.Permission') }}" :active="request()->is('admin/permissions') ? 'menu-active' : ''" :href="route('permissions.index')" :icon="[asset('images/permissions.svg'), asset('images/permissions.svg')]" />
