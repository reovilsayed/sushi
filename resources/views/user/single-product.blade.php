                    ...
                    <div class="row justify-content-center">
                        ...
                        <div class="col-md-7">
                            <h2 class="mb-3 singlePrice fs-3 mt-3">
                                {{ session()->get('locale') == 'ar' ? $product->name_ae : $product->name }}
                            </h2>
                            ...
                            <div class="row mt-5">
                                <div class="col-12">
                                    <p class="text-left bottomTitle">
                                        {{ session()->get('locale') == 'ar' ? $product->text_ae : $product->text }}</p>
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                document.querySelectorAll('.increase-btn').forEach(button => {
                    button.addEventListener('click', function() {
                        ...
                        if (currentTotal < maxQuantity) {
                            ...
                            alert("{{ __('sentence.you_cannot_select_more_than') }} " + maxQuantity +
                                " {{ __('sentence.items') }}");
                        }
                    });
                });
