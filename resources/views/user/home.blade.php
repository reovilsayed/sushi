@php
    $permissionActive = App\Models\Permission::where('key', 'home')->where('status', 'Active')->first();
@endphp
    ...
    <x-user>
                    ...
                    @foreach ($sliders as $index => $slider)
                        <div class="carousel-item {{ $index == 0 ? 'active' : '' }}" data-bs-interval="4000">
                            ...
                            <div class="carousel-caption d-block text-start" style="top: 25%; left: 8%;">
                                ...
                                <p class="col-8 slidetext">
                                    {{ App::getLocale() == 'ar' ? $slider->title_ae : $slider->title }}</p>

                                <a href="#location" class="btn btn-orange-normal" id="slideBtn"
                                    dir="{{ App::getLocale() == 'ar' ? 'rtl' : 'ltr' }}">{{ __('sentence.location') }}</a>
                            </div>
                        </div>
                    @endforeach
                </div>
                        ...
                        <div class="row">
                            ...
                            <div class="col-12" data-aos="fade-left">
                                <img src="{{ Storage::url(Settings::setting('slide.right_bottom')) }}"
                                    class="img-fluid" alt="right_bottom">
                            </div>

                        </div>
                    </div>
                    <div class="col-3  mt-5" data-aos="fade-down">
                        <img src="{{ Storage::url(Settings::setting('slide.right')) }}" class="img-fluid"
                            alt="right">
                    </div>
                </div>
            </div>
        ...
        <section id="location" class="menu section bg-transparent">
            ...
            <div class="loction_rtr container section-title text-center " data-aos="fade-up">
                <h2 id="loction_rtr_h2" dir="{{ App::getLocale() == 'ar' ? 'rtl' : 'ltr' }}">
