@php
    $permissionActive = App\Models\Permission::where('key', 'recruitment')->where('status', 'Active')->first();
@endphp
                ...
                <div class="row gy-4">
                    ...
                    <div class="col-lg-8">
                        <form action="{{ route('recrutment.mail') }}" method="post" class="php-email-form"
                            ...
                            <div class="row gy-4">
                                ...
                                <div class="col-md-6">
                                    <input type="text" name="name" class="form-control"
                                        placeholder="{{ __('sentence.your_name') }}" required="">
                                </div>
                                ...
                                <div class="col-md-6">
                                    <select class="form-select mb-3" style="border: 1px solid var(--accent-color);"
                                        name="terget_position">
                                        <option selected>{{ __('sentence.target_position') }}</option>
                                        <option value="{{ __('sentence.versatile_delivery_person') }}">
                                            {{ __('sentence.versatile_delivery_person') }} </option>
                                        <option value="{{ __('sentence.multipurpose_server') }}">
                                            {{ __('sentence.multipurpose_server') }} </option>
                                        <option value="{{ __('sentence.kitchen_assistant') }}">
                                            {{ __('sentence.kitchen_assistant') }} </option>
                                        <option value="{{ __('sentence.chef_sushi') }} ">
                                            {{ __('sentence.chef_sushi') }} </option>
                                        <option value="{{ __('sentence.manager') }}">{{ __('sentence.manager') }}
                                        </option>
                                    </select>
                                </div>
                                <div class="col-md-6">
                            ...
                            <button type="submit"
                                class="d-xl-block user-logout-button mt-3">{{ __('sentence.submit') }}</button>
                        </form>
