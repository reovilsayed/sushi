        ...
        <div class="container" data-aos="fade-up" data-aos-delay="100">
            <div class="row gy-4">
                <div class="col-md-8 ">
                    ...
                    <form method="POST" action="{{ route('user.update.name') }}" class="php-email-form" data-aos="fade-up"
                        data-aos-delay="200">
                        @csrf
                        <div class="row gy-4">
                ...
                <div class="col-md-4 ">
                    ...
                    <form method="POST" action="{{ route('user.update.password') }}" class="php-email-form" data-aos="fade-up"
                        data-aos-delay="200">
                        @csrf
                        <div class="row gy-4">
                            <div class="col-md-12">
        ...
        <div class="table-responsive">
            <table class="cart_table  table-responsive">
                ...
                <tbody class="table_body">
                        ...
                        <tr class="">
                            <td class="py-3" style="padding-left:20px;">1</td>
                            <td class="">this is order</td>
                            <td class="">this is time</td>
                        </tr> 
